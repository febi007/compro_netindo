!(function (t, e) {
    ...
    (function (t) {
        ...
        264: function (t, e, n) {
             ...
             * Licensed under the MIT license */ !(function (r, s, o, a) {
                "use strict";
                var u,
                ...
                function j(t, e, n) {
                    ...
                    s && (t.session = {}),
                        ...
                        (function (t, e) {
                            ...
                            r > 1 && !n.firstMultiple ? (n.firstMultiple = k(e)) : 1 === r && (n.firstMultiple = !1);
                            var s = n.firstInput,
                                o = n.firstMultiple,
                            ...
                            (e.timeStamp = f()),
                                ...
                                (function (t, e) {
                                    var n = e.center,
                                        ...
                                        r = t.prevDelta || {},
                                        s = t.prevInput || {};
                                    (1 !== e.eventType && 4 !== s.eventType) || ((r = t.prevDelta = { x: s.deltaX || 0, y: s.deltaY || 0 }), (i = t.offsetDelta = { x: n.x, y: n.y }));
                                    (e.deltaX = r.x + (n.x - i.x)), (e.deltaY = r.y + (n.y - i.y));
                                })(n, e),
                                (e.offsetDirection = U(e.deltaX, e.deltaY));
                            var h = H(e.deltaTime, e.deltaX, e.deltaY);
                            (e.overallVelocityX = h.x),
                                (e.overallVelocityY = h.y),
                                (e.overallVelocity = p(h.x) > p(h.y) ? h.x : h.y),
                                (e.scale = o ? ((c = o.pointers), (l = i), V(l[0], l[1], W) / V(c[0], c[1], W)) : 1),
                                (e.rotation = o
                                    ? (function (t, e) {
                                ...
                                (function (t, e) {
                                    ...
                                    if (8 != e.eventType && (a > 25 || void 0 === o.velocity)) {
                                        var u = e.deltaX - o.deltaX,
                                            h = e.deltaY - o.deltaY,
                                            c = H(a, u, h);
                                        (i = c.x), (r = c.y), (n = p(c.x) > p(c.y) ? c.x : c.y), (s = U(u, h)), (t.lastInterval = e);
                ...
                function k(t) {
                    for (var e = [], n = 0; n < t.pointers.length; ) (e[n] = { clientX: l(t.pointers[n].clientX), clientY: l(t.pointers[n].clientY) }), n++;
                    return { timeStamp: f(), pointers: e, center: L(e), deltaX: t.deltaX, deltaY: t.deltaY };
                }
                function L(t) {
                    var e = t.length;
                ...
                function B() {
                    (this.evEl = "mousedown"), (this.evWin = "mousemove mouseup"), (this.pressed = !1), q.apply(this, arguments);
                }
                E(B, q, {
                    handler: function (t) {
                        var e = Z[t.type];
                        ...
                        2 & e && 1 !== t.which && (e = 4),
                        this.pressed && (4 & e && (this.pressed = !1), this.callback(this.manager, e, { pointers: [t], changedPointers: [t], pointerType: "mouse", srcEvent: t }));
                    },
                });
                ...
                function tt() {
                    (this.evEl = K), (this.evWin = Q), q.apply(this, arguments), (this.store = this.manager.session.pointerEvents = []);
                }
                r.MSPointerEvent && !r.PointerEvent && ((K = "MSPointerDown"), (Q = "MSPointerMove MSPointerUp MSPointerCancel")),
                    E(tt, q, {
                        handler: function (t) {
                            var e = this.store,
                                n = !1,
                ...
                E(nt, q, {
                    handler: function (t) {
                        ...
                        if ((1 === e && (this.started = !0), this.started)) {
                            ...
                            12 & e && n[0].length - n[1].length == 0 && (this.started = !1), this.callback(this.manager, e, { pointers: n[0], changedPointers: n[1], pointerType: "touch", srcEvent: t });
                        }
                    },
                });
                var rt = { touchstart: 1, touchmove: 2, touchend: 4, touchcancel: 8 };
                function st() {
                    (this.evTarget = "touchstart touchmove touchend touchcancel"), (this.targetIds = {}), q.apply(this, arguments);
                }
                function ot(t, e) {
                    var n = O(t.touches),
                        i = this.targetIds;
                ...
                function at() {
                    ...
                    (this.touch = new st(this.manager, t)), (this.mouse = new B(this.manager, t)), (this.primaryTouch = null), (this.lastTouches = []);
                }
                function ut(t, e) {
                    1 & t ? ((this.primaryTouch = e.changedPointers[0].identifier), ht.call(this, e)) : 12 & t && ht.call(this, e);
                }
                function ht(t) {
                ...
                dt.prototype = {
                    set: function (t) {
                        "compute" == t && (t = this.compute()), pt && this.manager.element.style && ft[t] && (this.manager.element.style[lt] = t), (this.actions = t.toLowerCase().trim());
                    },
                    update: function () {
                        ...
                        return (
                            m(this.manager.recognizers, function (e) {
                                ...
                                (function (t) {
                                    ...
                                    if (x(t, "manipulation")) return "manipulation";
                                    return "auto";
                                })(t.join(" "))
                        );
                    },
                    preventDefaults: function (t) {
                        ...
                        if (this.manager.session.prevented) e.preventDefault();
                            ...
                            var i = this.actions,
                                r = x(i, "none") && !ft.none,
                                s = x(i, "pan-y") && !ft["pan-y"],
                                o = x(i, "pan-x") && !ft["pan-x"];
                            if (r) {
                ...
                function vt(t) {
                    (this.options = u({}, this.defaults, t || {})), (this.id = R++), (this.manager = null), (this.options.enable = _(this.options.enable, !0)), (this.state = 1), (this.simultaneous = {}), (this.requireFail = []);
                }
                function mt(t) {
                ...
                function Pt(t, e) {
                    return ((e = e || {}).recognizers = _(e.recognizers, Pt.defaults.preset)), new xt(t, e);
                }
                (vt.prototype = {
                    defaults: {},
                    set: function (t) {
                    ...
                    requireFailure: function (t) {
                        ...
                        return -1 === D(e, (t = yt(t, this))) && (e.push(t), t.requireFailure(this)), this;
                    },
                    ...
                    emit: function (t) {
                        ...
                        n < 8 && i(e.options.event + mt(n)), i(e.options.event), t.additionalEvent && i(t.additionalEvent), n >= 8 && i(e.options.event + mt(n));
                    },
                    tryEmit: function (t) {
                    ...
                    recognize: function (t) {
                        var e = u({}, t);
                        if (!I(this.options.enable, [this, e])) return this.reset(), void (this.state = 32);
                    ...
                    E(Et, Tt, {
                        ...
                        directionTest: function (t) {
                            var e = this.options,
                                ...
                                o = t.deltaY;
                            return (
                                r & e.direction || (6 & e.direction ? ((r = 0 === s ? 1 : s < 0 ? 2 : 4), (n = s != this.pX), (i = Math.abs(t.deltaX))) : ((r = 0 === o ? 1 : o < 0 ? 8 : 16), (n = o != this.pY), (i = Math.abs(t.deltaY)))),
                                    (t.direction = r),
                    ...
                    (Pt.defaults = {
                        ...
                        inputTarget: null,
                        inputClass: null,
                        preset: [[_t, { enable: !1 }], [bt, { enable: !1 }, ["rotate"]], [At, { direction: 6 }], [Et, { direction: 6 }, ["swipe"]], [St], [St, { event: "doubletap", taps: 2 }, ["tap"]], [It]],
                        cssProps: { userSelect: "none", touchSelect: "none", touchCallout: "none", contentZooming: "none", userDrag: "none", tapHighlightColor: "rgba(0,0,0,0)" },
                    });
                function xt(t, e) {
                    var n;
                    (this.options = u({}, Pt.defaults, e || {})),
                        ...
                        (this.oldCssProps = {}),
                        (this.element = t),
                        (this.input = new ((n = this).options.inputClass || (X ? tt : Y ? st : N ? at : B))(n, j)),
                ...
                (xt.prototype = {
                    ...
                    ((void 0 !== r ? r : "undefined" != typeof self ? self : {}).Hammer = Pt),
                void 0 ===
                (i = function () {
                    return Pt;
