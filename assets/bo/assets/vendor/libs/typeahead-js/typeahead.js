    ...
    (function (t) {
        ...
        11: function (t, e) {
            ...
            var a,
                ...
                h = -1;
            function f() {
                l && a && ((l = !1), a.length ? (c = a.concat(c)) : (h = -1), c.length && d());
            }
            function d() {
                if (!l) {
                    var t = u(f);
                    ...
                    return (o.Bloodhound =
                        ((e = t),
                                        ...
                                        n.mixin(u.prototype, {
                                            ...
                                            _get: function (e, n) {
                                                var r,
                                                    ...
                                                    u = this;
                                                function a(t) {
                                                    n(null, t), u._cache.set(r, t);
                                                }
                                                function c() {
                                                    n(!0);
                                                }
                                                function l() {
                                                    t--, delete i[r], u.onDeckRequestArgs && (u._get.apply(u, u.onDeckRequestArgs), (u.onDeckRequestArgs = null));
                                                }
                                                (r = this._fingerprint(e)),
                                                this.cancelled ||
                                                r !== this.lastReq ||
                                                ((o = i[r]) ? o.done(a).fail(c) : t < s ? (t++, (i[r] = this._send(e).done(a).fail(c).always(l))) : (this.onDeckRequestArgs = [].slice.call(arguments, 0)));
                                            },
                                            get: function (t, i) {
                                                var r, s;
                                            ...
                                            (t = n.isArray(t) ? t : [t]),
                                                n.each(t, function (t) {
                                                    ...
                                                    (e.datums[(s = e.identify(t))] = t),
                                                        ...
                                                        n.each(o, function (t) {
                                                            var n, i, o;
                                                            for (n = e.trie, i = t.split(""); (o = i.shift()); ) (n = n.c[o] || (n.c[o] = r())).i.push(s);
                                                        });
                                                });
                                        },
                                        get: function (t) {
                            ...
                            (c = (function () {
                                ...
                                return (
                                    (t = { data: "data", protocol: "protocol", thumbprint: "thumbprint" }),
                                        n.mixin(e.prototype, {
                                            _settings: function () {
                            ...
                            (l = (function () {
                                "use strict";
                                function t(t) {
                                    (this.url = t.url), (this.prepare = t.prepare), (this.transform = t.transform), (this.transport = new u({ cache: t.cache, limiter: t.limiter, transport: t.transport }));
                                }
                                return (
                                    n.mixin(t.prototype, {
                                        _settings: function () {
                            ...
                            (h = (function () {
                                ...
                                return function (i) {
                                    var r, s;
                                    return (
                                        (r = { initialize: !0, identify: n.stringify, datumTokenizer: null, queryTokenizer: null, sufficient: 5, sorter: null, local: [], prefetch: null, remote: null }),
                                        !(i = n.mixin(r, i || {})).datumTokenizer && e.error("datumTokenizer is required"),
                                        !i.queryTokenizer && e.error("queryTokenizer is required"),
                                            ...
                                            (i.prefetch = (function (i) {
                                                var r;
                                                return i
                                                    ? ((r = { url: null, ttl: 864e5, cache: !0, cacheKey: null, thumbprint: "", prepare: n.identity, transform: n.identity, transport: null }),
                                                        (i = n.isString(i) ? { url: i } : i),
                                                    !(i = n.mixin(r, i)).url && e.error("prefetch requires url to be set"),
                                            ...
                                            (i.remote = (function (i) {
                                                ...
                                                if (i)
                                                    return (
                                                        (r = { url: null, cache: !0, prepare: null, replace: null, wildcard: null, limiter: null, rateLimitBy: "debounce", rateLimitWait: 300, transform: n.identity, transport: null }),
                                                            (i = n.isString(i) ? { url: i } : i),
                    ...
                    return (
                        (e = t),
                                        ...
                                        (s = n.mixin({}, t, i)),
                                            {
                                                css: (r = {
                                                    css:
                                                        ...
                                                        n.isMsie() && n.mixin(u.input, { backgroundImage: "url(data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7)" }),
                                                            u),
                                                    classes: s,
                                                    html: ((o = s), { wrapper: '<span class="' + o.wrapper + '"></span>', menu: '<div class="' + o.menu + '"></div>' }),
                                                    selectors: e(s),
                                                }).css,
                                                html: r.html,
                                                classes: r.classes,
                            ...
                            (s = (function () {
                                ...
                                return (
                                    (t = { render: "rendered", cursorchange: "cursorchanged", select: "selected", autocomplete: "autocompleted" }),
                                        n.mixin(i.prototype, {
                            ...
                            (o = (function () {
                                ...
                                return {
                                    ...
                                    trigger: function (n) {
                                        var i, s, o, u, a;
                                        if (!this._callbacks) return this;
                                        for (n = n.split(t), o = [].slice.call(arguments, 1); (i = n.shift()) && (s = this._callbacks[i]); ) (u = r(s.sync, this, [i].concat(o))), (a = r(s.async, this, [i].concat(o))), u() && e(a);
                                        return this;
                                    },
                                };
                                function n(e, n, i, r) {
                                    ...
                                    for (
                                        ...
                                        (this._callbacks[s] = this._callbacks[s] || { sync: [], async: [] }), this._callbacks[s][e].push(i);
                                    return this;
                                }
                                function r(t, e, n) {
                                    return function () {
                            ...
                            (u = (function (t) {
                                ...
                                return function (i) {
                                    ...
                                    (i = n.mixin({}, e, i)).node &&
                                    i.pattern &&
                                    ((i.pattern = n.isArray(i.pattern) ? i.pattern : [i.pattern]),
                                        (r = (function (t, e, i) {
                                            ...
                                            isCursorAtEnd: function () {
                                                ...
                                                return (
                                                    (t = this.$input.val().length),
                                                        ...
                                                        n.isNumber(e) ? e === t : !document.selection || ((i = document.selection.createRange()).moveStart("character", -t), t === i.text.length)
                                                );
                                            },
                                            destroy: function () {
                            ...
                            (c = (function () {
                                ...
                                function r(t, r) {
                                    ...
                                    t.name && ((s = t.name), !/^[_a-zA-Z0-9-]+$/.test(s)) && e.error("invalid dataset name: " + t.name),
                                        ...
                                        (this.displayFn =
                                            ((o = (o = t.display || t.displayKey) || n.stringify),
                                                n.isFunction(o)
                                                    ? o
                                                    : function (t) {
                                                        return t[o];
                                        ...
                                        (this.templates =
                                            ((u = t.templates),
                                                (a = this.displayFn),
                                                {
                                                    notFound: u.notFound && n.templatify(u.notFound),
                                                    pending: u.pending && n.templatify(u.pending),
                                                    header: u.header && n.templatify(u.header),
                                                    footer: u.footer && n.templatify(u.footer),
                                                    suggestion:
                                                    u.suggestion ||
                                                    function (t) {
                                                        return e("<div>").text(a(t));
                                                    },
                                                })),
                                ...
                                return (
                                    (t = { val: "tt-selectable-display", obj: "tt-selectable-object" }),
                                        ...
                                        (r.extractData = function (n) {
                                            var i = e(n);
                                            return i.data(t.obj) ? { val: i.data(t.val) || "", obj: i.data(t.obj) || null } : null;
                                        }),
                                        n.mixin(r.prototype, o, {
                                            ...
                                            _append: function (t, e) {
                                                (e = e || []).length && this.$lastSuggestion.length
                                                    ...
                                                    : e.length
                                                    ? this._renderSuggestions(t, e)
                                                    : !this.$lastSuggestion.length && this.templates.notFound && this._renderNotFound(t),
                                            ...
                                            _getSuggestionsFragment: function (i, r) {
                                                ...
                                                return (
                                                    (s = document.createDocumentFragment()),
                                                        n.each(r, function (n) {
                                                            var r, u;
                                                            (u = o._injectQuery(i, n)),
                                                                (r = e(o.templates.suggestion(u))
                                                                    .data(t.obj, n)
                                                                    .data(t.val, o.displayFn(n))
                                                                    .addClass(o.classes.suggestion + " " + o.classes.selectable)),
                                                                s.appendChild(r[0]);
                                                        }),
                                ...
                                function t(t, i) {
                                    ...
                                    (t = t || {}).node || e.error("node is required"),
                                        ...
                                        (this.datasets = n.map(t.datasets, function (t) {
                                            ...
                                            return (t.node = n.length ? n : e("<div>").appendTo(r.$node)), new c(t, i);
                                        }));
                                }
                                return (
                                    n.mixin(t.prototype, o, {
                                        ...
                                        getSelectableData: function (t) {
                                            return t && t.length ? c.extractData(t) : null;
                                        },
                            ...
                            (h = (function () {
                                ...
                                return (
                                    n.mixin(e.prototype, l.prototype, {
                                        open: function () {
                                ...
                                function t(t, r) {
                                    ...
                                    this.input.hasFocus() && this.activate(),
                                        ...
                                        this.input
                                            ...
                                            .onSync("enterKeyed", u, this)
                                            .onSync("tabKeyed", a, this)
                                        ...
                                        _updateHint: function () {
                                            ...
                                            (t = this.menu.getTopSelectable()),
                                                ...
                                                !e || n.isBlankString(i) || this.input.hasOverflow()
                                                    ...
                                                    : ((r = a.normalizeQuery(i)), (s = n.escapeRegExChars(r)), (o = new RegExp("^(?:" + s + ")(.+$)", "i").exec(e.val)) && this.input.setHint(i + o[1]));
                                        },
                                        isEnabled: function () {
                                            return this.enabled;
                                        },
                            ...
                            void (function () {
                                ...
                                function d(t, e) {
                                    t.data(i.attrs, { dir: t.attr("dir"), autocomplete: t.attr("autocomplete"), spellcheck: t.attr("spellcheck"), style: t.attr("style") }),
                                ...
                                (t = e.fn.typeahead),
                                    (i = { www: "tt-www", attrs: "tt-attrs", typeahead: "tt-typeahead" }),
                                    (o = {
                                        initialize: function (t, o) {
                                            ...
                                            function g() {
                                                ...
                                                n.each(o, function (e) {
                                                    ...
                                                    (_ = !1 !== t.menu && !y),
                                                v && (m = c(r, u)),
                                                _ && (y = e(u.html.menu).css(u.css.menu)),
                                                m && m.val(""),
                                                    (r = d(r, u)),
                                                (v || _) &&
                                                (g.css(u.css.wrapper),
                                                    r.css(v ? u.css.input : u.css.inputWithNoHint),
                                                    r
                                                        .wrap(g)
                                                        .parent()
                                                        .prepend(v ? m : null)
                                                    ...
                                                    (T = _ ? h : l),
                                                    (b = new s({ el: r })),
                                                    (w = new a({ hint: m, input: r }, u)),
                                                    (S = new T({ node: y, datasets: o }, u)),
                                                    (x = new f({ input: w, menu: S, eventBus: b, minLength: t.minLength }, u)),
                                                    r.data(i.www, u),
                                                    r.data(i.typeahead, x);
                                            }
                                        },
                                        isEnabled: function () {
                                            var t;
                                            return (
                                                u(this.first(), function (e) {
                                                    t = e.isEnabled();
                                                }),
                                                    t
                                            );
                                                ...
                                                u(this, function (t, e) {
                                                    !(function (t) {
                                                        ...
                                                        (e = t.data(i.www)),
                                                            ...
                                                            t.removeData(i.typeahead).removeData(i.www).removeData(i.attr).removeClass(e.classes.input),
                                                        r.length && (t.detach().insertAfter(r), r.remove());
                                                    })(e),
                                                        t.destroy();
                                                }),
                                                    this
