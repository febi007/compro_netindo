!function(t, e) {
    ...
    187: function(t, e, i) {
        t.exports = function() {
            ...
            var g, c = ()=>/(?=.*chrome)(?=.*android)/i.test(navigator.userAgent), p = {
                init() {
                    this.DOM.dropdown = this.parseTemplate("dropdown", [this.settings]),
                        this.DOM.dropdown.content = this.DOM.dropdown.querySelector(this.settings.classNames.dropdownWrapperSelector)
                },
                show(t) {
                    var e, s, a, n = this.settings, o = "mix" == n.mode && !n.enforceWhitelist, r = !n.whitelist || !n.whitelist.length, d = "manual" == n.dropdown.position;
                    if (t = void 0 === t ? this.state.inputText : t,
                        (!r || o || n.templates.dropdownItemNoMatch) && !1 !== n.dropdown.enable && !this.state.isLoading) {
                        if (clearTimeout(this.dropdownHide__bindEventsTimeout),
                            ...
                            n.templates.dropdownItemNoMatch && (a = n.templates.dropdownItemNoMatch.call(this, {
                                value: t
                            }))),
                                !a) {
                            if (this.suggestedListItems.length)
                                t && o && !this.state.editing.scope && !i(this.suggestedListItems[0].value, t) && this.suggestedListItems.unshift({
                                    value: t
                                });
                            else {
                            ...
                            s = "" + (l(e = this.suggestedListItems[0]) ? e.value : e),
                            n.autoComplete && s && 0 == s.indexOf(t) && this.input.autocomplete.suggest.call(this, e)
                        }
                        this.dropdown.fill.call(this, a),
                        n.dropdown.highlightFirst && this.dropdown.highlightOption.call(this, this.DOM.dropdown.content.children[0]),
                ...
                fill(t) {
                    ...
                    t = "string" == typeof t ? t : this.dropdown.createListHTML.call(this, t || this.suggestedListItems),
                        this.DOM.dropdown.content.innerHTML = (e = t) ? e.replace(/\>[\r\n ]+\</g, "><").replace(/(<.*?>)|\s+/g, (t,e)=>e || " ") : ""
                },
                refilter(t) {
                    t = t || this.state.dropdown.query || "",
                        this.suggestedListItems = this.dropdown.filterListItems.call(this, t),
                        this.dropdown.fill.call(this),
                    this.suggestedListItems.length || this.dropdown.hide.call(this),
                        this.trigger("dropdown:updated", this.DOM.dropdown)
                },
                position(t) {
                    var e = this.settings.dropdown;
                    if ("manual" != e.position) {
                        var i, s, a, n, o, r, l = this.DOM.dropdown, d = e.placeAbove, h = document.documentElement.clientHeight, g = Math.max(document.documentElement.clientWidth || 0, window.innerWidth || 0) > 480 ? e.position : "all", c = this.DOM["input" == g ? "input" : "scope"];
                        t = t || l.clientHeight,
                        this.state.dropdown.visible && ("text" == g ? (a = (i = this.getCaretGlobalPosition()).bottom,
                            s = i.top,
                            n = i.left,
                            o = "auto") : (r = function(t) {
                            for (var e = 0, i = 0; t; )
                        ...
                        onKeyDown(t) {
                            ...
                            switch (t.key) {
                                ...
                                case "Up":
                                    var s;
                                    t.preventDefault(),
                                    e && (e = e[("ArrowUp" == t.key || "Up" == t.key ? "previous" : "next") + "ElementSibling"]),
                                    e || (s = this.DOM.dropdown.content.children,
                                        e = s["ArrowUp" == t.key || "Up" == t.key ? s.length - 1 : 0]),
                                        i = this.dropdown.getSuggestionDataByNode.call(this, e),
                                        this.dropdown.highlightOption.call(this, e, !0);
                                    break;
                                case "Escape":
                                case "Esc":
                                ...
                                case "Tab":
                                    if ("mix" != this.settings.mode && e && !this.settings.autoComplete.rightKey && !this.state.editing) {
                                        ...
                                        return this.input.autocomplete.set.call(this, a),
                                            !1
                                    }
                                    return !0;
                                case "Enter":
                ...
                selectOption(t) {
                    ...
                    if (!t)
                        return this.addTags(this.state.inputText, !0),
                            void (s && this.dropdown.hide.call(this));
                    ...
                    this.trigger("dropdown:select", {
                        ...
                        a && n ? (this.state.editing ? this.onEditTagDone(null, d({
                            __isValid: !0
                        }, n)) : this["mix" == this.settings.mode ? "addMixTags" : "addTags"]([n], i),
                        setTimeout(()=>{
                ...
                selectAll() {
                    return this.suggestedListItems.length = 0,
                        this.dropdown.hide.call(this),
                        this.addTags(this.dropdown.filterListItems.call(this, ""), !0),
                        this
                },
                filterListItems(t, e) {
                    var i, s, a, n, o, r = this.settings, d = r.dropdown, g = (e = e || {},
                        t = "select" == r.mode && this.value.length && this.value[0][r.tagTextProp] == t ? "" : t,
                        []), c = r.whitelist, p = d.maxItems || 1 / 0, u = d.searchKeys, m = 0;
                    if (!t || !u.length)
                        return (r.duplicates ? c : c.filter(t=>!this.isTagDuplicate(l(t) ? t.value : t))).slice(0, p);
                    function v(t, e) {
                        return e.toLowerCase().split(" ").every(e=>t.includes(e.toLowerCase()))
                    }
                    for (o = d.caseSensitive ? "" + t : ("" + t).toLowerCase(); m < c.length; m++) {
                        i = c[m]instanceof Object ? c[m] : {
                            value: c[m]
                        };
                        let t = Object.keys(i).some(t=>u.includes(t)) ? u : ["value"];
                        if (d.fuzzySearch && !e.exact ? (a = t.reduce((t,e)=>t + " " + (i[e] || ""), "").toLowerCase(),
                            d.accentedSearch && (a = h(a),
                                o = h(o)),
                                s = v(a, o)) : s = t.some(t=>{
                            var s = "" + (i[t] || "");
                        return d.accentedSearch && (s = h(s),
                            o = h(o)),
                ...
                createListHTML(t) {
                    ...
                    t.value = i && "string" == typeof i ? o(i) : i;
                    var s = this.settings.templates.dropdownItem.call(this, t);
                    return s.replace(/\s*tagifySuggestionIdx=(["'])(.*?)\1/gim, "").replace(">", ` tagifySuggestionIdx="${e}">`)
                }
                ).join("")
                }
            }, u = {
            ...
            dropdownItemNoMatch: null
                ...
                binding(t=!0) {
                    ...
                    if (!this.state.mainEvents || !t)
                        ...
                        t && !this.listeners.main && (this.DOM.input.addEventListener(this.isIE ? "keydown" : "input", i[this.isIE ? "onInputIE" : "onInput"].bind(this)),
                            window.addEventListener("keydown", i.onWindowKeyDown.bind(this)),
                ...
                callbacks: {
                    onFocusBlur(t) {
                        ...
                        if (!o && !r)
                            if (this.state.hasFocus = "focus" == s && +new Date,
                                    this.toggleFocusClass(this.state.hasFocus),
                                "mix" != i.mode) {
                                if ("focus" == s)
                                    return this.trigger("focus", n),
                                        void (0 === i.dropdown.enabled && this.dropdown.show.call(this));
                                "blur" == s && (this.trigger("blur", n),
                                    this.loading(!1),
                                "select" == this.settings.mode && l && (e = ""),
                                ("select" == this.settings.mode && e ? !this.value.length || this.value[0].value != e : e && !this.state.actions.selectOption && i.addTagOnBlur) && this.addTags(e, !0),
                                "select" != this.settings.mode || e || this.removeTags()),
                                    this.DOM.input.removeAttribute("style"),
                                    this.dropdown.hide.call(this)
                            } else
                                "focus" == s ? this.trigger("focus", n) : "blur" == t.type && (this.trigger("blur", n),
                                    this.loading(!1),
                                    this.dropdown.hide.call(this),
                    ...
                    onWindowKeyDown(t) {
                        ...
                        if (i.classList.contains(this.settings.classNames.tag) && this.DOM.scope.contains(document.activeElement))
                    ...
                    onKeydown(t) {
                        var e = this.trim(t.target.textContent);
                        if (this.trigger("keydown", {
                            ...
                            switch (t.key) {
                                ...
                                case "Backspace":
                                    if (this.state.editing)
                                        return;
                                    var i, s, o, r = document.getSelection(), l = "Delete" == t.key && r.anchorOffset == (r.anchorNode.length || 0), d = 1 == r.anchorNode.nodeType || !r.anchorOffset && r.anchorNode.previousElementSibling, h = a(this.DOM.input.innerHTML), p = this.getTagElms();
                                    if ("edit" == this.settings.backspace && d)
                                        return i = 1 == r.anchorNode.nodeType ? null : r.anchorNode.previousElementSibling,
                                            setTimeout(this.editTag.bind(this), 0, i),
                                            void t.preventDefault();
                                    if (c() && d)
                                        return o = n(d),
                                        d.hasAttribute("readonly") || d.remove(),
                                            this.DOM.input.focus(),
                                        void setTimeout(()=>{
                            ...
                            if ("BR" == r.anchorNode.nodeName)
                                return;
                            if ((l || d) && 1 == r.anchorNode.nodeType ? s = 0 == r.anchorOffset ? l ? p[0] : null : p[r.anchorOffset - 1] : l ? s = r.anchorNode.nextElementSibling : d && (s = d),
                                3 == r.anchorNode.nodeType && !r.anchorNode.nodeValue && r.anchorNode.previousElementSibling && t.preventDefault(),
                                (d || l) && !this.settings.backspace)
                                return void t.preventDefault();
                            if ("Range" != r.type && !r.anchorOffset && r.anchorNode == this.DOM.input && "Delete" != t.key)
                                return void t.preventDefault();
                            if ("Range" != r.type && s && s.hasAttribute("readonly"))
                                return void this.placeCaretAfterNode(n(s));
                            clearTimeout(g),
                                g = setTimeout(()=>{
                                    var t = document.getSelection()
                                    , e = a(this.DOM.input.innerHTML)
                                    , i = t.anchorNode.previousElementSibling;
                            if (!c() && e.length >= h.length && i && !i.hasAttribute("readonly") && (this.removeTags(i),
                                    this.fixFirefoxLastTagNoCaret(),
                                2 == this.DOM.input.children.length && "BR" == this.DOM.input.children[1].tagName))
                                return this.DOM.input.innerHTML = "",
                                    this.value.length = 0,
                                    !0;
                        ...
                        switch (t.key) {
                            case "Backspace":
                                this.state.dropdown.visible && "manual" != this.settings.dropdown.position || "" != e && 8203 != e.charCodeAt(0) || (!0 === this.settings.backspace ? this.removeTags() : "edit" == this.settings.backspace && setTimeout(this.editTag.bind(this), 0));
                                break;
                            case "Esc":
                            case "Escape":
                            ...
                            case "ArrowRight":
                            {
                                ...
                                if (t && this.settings.autoComplete.rightKey)
                                    return void this.addTags([t], !0);
                                break
                            }
                            case "Tab":
                            {
                                let i = "select" == this.settings.mode;
                                if (!e || i)
                                    return !0;
                                t.preventDefault()
                            }
                            case "Enter":
                                if (this.state.dropdown.visible || 229 == t.keyCode)
                                    return;
                                t.preventDefault(),
                                setTimeout(()=>{
                                    this.state.actions.selectOption || this.addTags(e, !0)
                        }
                    )
                    }
                    },
                    onInput(t) {
                        ...
                        this.state.inputText != e && (this.input.set.call(this, e, !1),
                            -1 != e.search(this.settings.delimiters) ? this.addTags(e) && this.input.set.call(this) : this.settings.dropdown.enabled >= 0 && this.dropdown[i ? "show" : "hide"].call(this, e),
                            this.trigger("input", s))
                    },
                    onMixTagsInput(t) {
                        var e, i, s, a, n, o, r, l, h = this.settings, g = this.value.length, p = this.getTagElms(), u = document.createDocumentFragment(), m = window.getSelection().getRangeAt(0), v = [].map.call(p, t=>this.tagData(t).value);
                        if ("deleteContentBackward" == t.inputType && c() && this.events.callbacks.onKeydown.call(this, {
                                target: t.target,
                                key: "Backspace"
                            }),
                        ...
                        u.childNodes.length && (m.insertNode(u),
                            this.setRangeAtStartEnd(!1, u.lastChild)),
                        p.length != g)
                        return this.value = [].map.call(this.getTagElms(), t=>this.tagData(t)),
                        void this.update({
                        ...
                        if (window.getSelection && (o = window.getSelection()).rangeCount > 0 && 3 == o.anchorNode.nodeType) {
                            if ((m = o.getRangeAt(0).cloneRange()).collapse(!0),
                                    ...
                                    s = (e = m.toString().slice(0, m.endOffset)).split(h.pattern).length - 1,
                                ...
                                if (this.state.actions.ArrowLeft = !1,
                                    ...
                                    return this.state.tag.value = this.state.tag.value.replace(h.delimiters, ""),
                    ...
                    onPaste(t) {
                        var e, i;
                        t.preventDefault(),
                        this.settings.readonly || (e = t.clipboardData || window.clipboardData,
                            i = e.getData("Text"),
                        this.settings.hooks.beforePaste(t, {
                            tagify: this,
                            pastedText: i,
                            clipboardData: e
                        }).then(e=>{
                            ...
                            "mix" == this.settings.mode ? this.events.callbacks.onMixTagsInput.call(this, t) : this.addTags(this.DOM.input.textContent, !0))
                    }
                    ).catch(t=>t))
                    },
                    onEditTagInput(t, e) {
                    ...
                    onEditTagBlur(t) {
                        if (this.state.hasFocus || this.toggleFocusClass(),
                            ...
                            var e, i = this.settings, s = t.closest("." + i.classNames.tag), a = this.input.normalize.call(this, t), n = this.tagData(s).__originalData, o = s.innerHTML != s.__tagifyTagData.__originalHTML, r = this.validateTag({
                                [i.tagTextProp]: a
                            });
                            if (a)
                                if (o) {
                                    if (e = this.getWhitelistItem(a) || d({}, n, {
                                            [i.tagTextProp]: a,
                                            value: a,
                                            __isValid: r
                                        }),
                                            i.transformTag.call(this, e, n),
                                        !0 !== (r = this.validateTag({
                                        ...
                                        if (this.trigger("invalid", {
                                                ...
                                                i.editTags.keepInvalid)
                                            return;
                                        i.keepInvalidTags ? e.__isValid = r : e = n
                                    }
                                    this.onEditTagDone(s, e)
                                } else
                                    this.onEditTagDone(s, n);
                            else
                                this.onEditTagDone(s)
                        }
                    },
                    ...
                    onDoubleClickScope(t) {
                        ...
                        s && (e = s.classList.contains(this.settings.classNames.tagEditing),
            ...
            function f(t, e) {
                return t ? t.previousElementSibling && t.previousElementSibling.classList.contains("tagify") ? (console.warn("Tagify: ", "input element is already Tagified", t),
                    this) : (d(this, function(t) {
                            ...
                            if (a = a || {
                                ...
                                if (t.settings.isJQueryPlugin)
                                    ...
                                    try {
                                        ...
                                        if ((o = a.cloneData ? d({}, o) : o).tagify = this,
                                            s instanceof Object)
                                            for (var r in s)
                    ...
                    void (t.autofocus && this.DOM.input.focus())) : (console.warn("Tagify: ", "input element not found", t),
                    this)
            }
            return f.prototype = {
                dropdown: p,
                ...
                templates: m,
                parseTemplate(t, e) {
                    return t = this.settings.templates[t] || t,
                ...
                applySettings(t, e) {
                    ...
                    for (let t in i.classNames)
                        Object.defineProperty(i.classNames, t + "Selector", {
                            get() {
                    ...
                    "autoComplete"in e && !l(e.autoComplete) && (i.autoComplete = u.autoComplete,
                        i.autoComplete.enabled = e.autoComplete),
                    "mix" == i.mode && (i.autoComplete.rightKey = !0,
                        i.delimiters = e.delimiters || null,
                ...
                getAttributes(t) {
                    if ("[object Object]" != Object.prototype.toString.call(t))
                        return "";
                    var e, i, s = Object.keys(t), a = "";
                    for (i = s.length; i--; )
                        "__" != (e = s[i]).slice(0, 2) && "class" != e && t.hasOwnProperty(e) && void 0 !== t[e] && (a += " " + e + (void 0 !== t[e] ? `="${t[e]}"` : ""));
                    return a
                },
                setStateSelection() {
                ...
                getCSSVars() {
                    ...
                    }(t.getPropertyValue("--tag-hide-transition")))
                }
                },
                build(t) {
                    var e = this.DOM;
                ...
                loadOriginalValues(t) {
                    ...
                    if (void 0 === t && (t = i.mixMode.integrated ? this.DOM.input.textContent : this.DOM.originalInput.value),
                            this.removeAllTags({
                                withoutChangeEvent: !0
                            }),
                            t)
                ...
                placeCaretAfterNode(t) {
                    if (t && t.parentNode) {
                        var e = t.nextSibling
                            ...
                            , s = i.getRangeAt(0);
                        i.rangeCount && (s.setStartBefore(e || t),
                            s.setEndBefore(e || t),
                            i.removeAllRanges(),
                            i.addRange(s))
                    }
                ...
                editTag(t, e) {
                    ...
                    if (a) {
                        ...
                        e.skipValidation || (h = this.editTagToggleValidity(t, o.value)),
                            a.originalIsValid = h,
                ...
                editTagToggleValidity(t, e) {
                    ...
                    if (s)
                        return i = !(!s.__isValid || 1 == s.__isValid),
                ...
                onEditTagDone(t, e) {
                    ...
                    this.trigger("edit:beforeUpdate", i, {
                        ...
                        t && e[this.settings.tagTextProp] ? (this.editTagToggleValidity(t),
                            t = this.replaceTag(t, e),
                        this.settings.a11y.focusableTags && t.focus()) : t && this.removeTags(t),
                ...
                replaceTag(t, e) {
                    ...
                    e.__isValid && 1 != e.__isValid && d(e, this.getInvalidTagAttrs(e, e.__isValid));
                ...
                injectAtCaret(t, e) {
                    if (e = e || this.state.selection.range)
                        return "string" == typeof t && (t = document.createTextNode(t)),
                            e.deleteContents(),
                            e.insertNode(t),
                ...
                input: {
                    set(t="", e=!0) {
                        ...
                        e && (this.DOM.input.innerHTML = o("" + t)),
            ...
            tagData: (t,e,i)=>t ? (e && (t.__tagifyTagData = i ? e : d({}, t.__tagifyTagData || {}, e)),
                t.__tagifyTagData) : (console.warn("tag elment doesn't exist", t, e),
                e),
                isTagDuplicate(t, e) {
                var s = this.settings;
                return "select" != s.mode && this.value.reduce((a,n)=>i(this.trim("" + t), n.value, e || s.dropdown.caseSensitive) ? a + 1 : a, 0)
            },
            getTagIndexByValue(t) {
                var e = [];
                return this.getTagElms().forEach((s,a)=>{
                    i(this.trim(s.textContent), t, this.settings.dropdown.caseSensitive) && e.push(a)
            }
            ),
                e
            },
            ...
            getWhitelistItem(t, e, s) {
                e = e || "value";
                var a, n = this.settings;
                return (s = s || n.whitelist).some(s=>{
                    var o = "string" == typeof s ? s : s[e] || s.value;
                if (i(o, t, n.dropdown.caseSensitive, n.trim))
                    return a = "string" == typeof s ? {
                        value: s
                    } : s,
                        !0
            }
            ),
                a || "value" != e || "value" == n.tagTextProp || (a = this.getWhitelistItem(t, n.tagTextProp, s)),
                    a
            },
            validateTag(t) {
                var e = this.settings
            ...
            normalizeTags(t) {
                ...
                if ("number" == typeof t && (t = t.toString()),
                    ...
                    l && (t = [].concat(...t.map(t=>t.value ? t : d(t))));
            ...
            selectTag(t, e) {
                if (!this.settings.enforceWhitelist || this.isTagWhitelisted(e.value))
                    return this.input.set.call(this, e[this.settings.tagTextProp || "value"], !0),
            ...
            addTags(t, e, i=this.settings.skipInvalid) {
                ...
                return t && 0 != t.length ? (t = this.normalizeTags(t),
                    "mix" == a.mode ? this.addMixTags(t) : ("select" == a.mode && (e = !1),
                        this.DOM.input.removeAttribute("style"),
                    t.forEach(t=>{
                        var e, o = {}, r = Object.assign({}, t, {
                            value: t.value + ""
                        });
                if ((t = Object.assign({}, r)).__isValid = this.hasMaxTags() || this.validateTag(t),
                ...
                if (t.readonly && (o["aria-readonly"] = !0),
                ...
                t.length && e && this.input.set.call(this),
                    ...
                    s)) : ("select" == a.mode && this.removeAllTags(),
                    s)
            },
            addMixTags(t) {
                if (t[0].prefix || this.state.tag)
                    ...
                    i.appendChild(e),
                        this.insertAfterTag(e)
                }
                ),
                    e ? this.injectAtCaret(i) : (this.DOM.input.focus(),
            ...
            createTagElem(i, s) {
                i.__tagId = ([1e7] + -1e3 + -4e3 + -8e3 + -1e11).replace(/[018]/g, t=>(t ^ crypto.getRandomValues(new Uint8Array(1))[0] & 15 >> t / 4).toString(16));
                var a, n = d({}, i, function(i) {
                    for (var s = 1; s < arguments.length; s++) {
                        var a = null != arguments[s] ? arguments[s] : {};
                        s % 2 ? e(Object(a), !0).forEach((function(e) {
                                t(i, e, a[e])
                            }
                        )) : Object.getOwnPropertyDescriptors ? Object.defineProperties(i, Object.getOwnPropertyDescriptors(a)) : e(Object(a)).forEach((function(t) {
            ...
            reCheckInvalidTags() {
                ...
                this.getTagElms(t.classNames.tagNotAllowed).forEach((t,e)=>{
                    var i = this.tagData(t);
                !this.hasMaxTags() && !0 === this.validateTag(i) && (i = i.__preInvalidData ? i.__preInvalidData : {
                    value: i.value
                },
                    this.replaceTag(t, i))
            }
            ...
            removeTags(t, e, i) {
                ...
                t = t && t instanceof HTMLElement ? [t] : t instanceof Array ? t : t ? [t] : [this.getLastTag()],
                    s = t.reduce((t,e)=>(e && "string" == typeof e && (e = this.getTagElmByValue(e)),
                    e && t.push({
                        node: e,
            ...
            update(t) {
                ...
                this.settings.mixMode.integrated || (e.value = this.getInputValue()),
                    this.postUpdate(),
                !i && this.state.loadedOriginalValues && this.triggerChangeEvent()
            },
            getInputValue() {
                ...
                return function a(n) {
                    n.childNodes.forEach(n=>{
                        ...
                        if (n.classList.contains(e.settings.classNames.tag) && e.tagData(n)) {
                            if (e.tagData(n).__removed)
                                return;
                            return void (t += i[0] + JSON.stringify(s(e.tagData(n), e.dataProps)) + i[1])
                        }
            ...
            f.prototype.removeTag = f.prototype.removeTags,
                f
        }()
    },
    482: function(t, e, i) {
