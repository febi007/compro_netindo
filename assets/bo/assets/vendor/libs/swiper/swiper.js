    ...
    486: function(e, t, i) {
            ...
            return function() {
                ...
                if (void 0 === i[0]) {
                    for (var a = 0; a < this.length; a += 1)
                        b.indexOf(e) < 0 && (e in this[a] ? this[a][e]() : g(this[a]).trigger(e));
                    return this
                }
            ...
            for (var e = Object(arguments.length <= 0 ? void 0 : arguments[0]), t = ["__proto__", "constructor", "prototype"], i = 1; i < arguments.length; i += 1) {
                ...
                if (null != s)
                    for (var a = Object.keys(Object(s)).filter((function(e) {
                        ...
                        void 0 !== l && l.enumerable && (P(e[o]) && P(s[o]) ? s[o].__swiper__ ? e[o] = s[o] : k(e[o], s[o]) : !P(e[o]) && P(s[o]) ? (e[o] = {},
                            s[o].__swiper__ ? e[o] = s[o] : k(e[o], s[o])) : e[o] = s[o])
                    }
            }
            return e
        }
                            ...
                            e && !e.destroyed && e.initialized && (e.resize.observer = new ResizeObserver((function(t) {
                                    ...
                                    t.forEach((function(t) {
                                            var i = t.contentBoxSize
                                                , s = t.contentRect
                                                , n = t.target;
                                            n && n !== e.el || (a = s ? s.width : (i[0] || i).inlineSize,
                    ...
                    if (s.isTouchEvent = "touchstart" === o.type,
                        ...
                        if (!(!s.isTouchEvent && "button"in o && o.button > 0))
                            if (!s.isTouched || !s.isMoved)
                                if (!!a.noSwipingClass && "" !== a.noSwipingClass && o.target && o.target.shadowRoot && e.path && e.path[0] && (d = C(e.path[0])),
                                    ...
                                    if (k(s, {
                                        ...
                                        t.activeElement && C(t.activeElement).is(s.formElements) && t.activeElement !== d[0] && t.activeElement.blur();
        ...
        function j(e) {
            ...
            if (t.enabled) {
                ...
                var h, p = M(), u = p - i.touchStartTime;
                ...
                if (i.isTouched = !1,
                    ...
                    if (s.freeMode) {
                        ...
                        for (var O = 0, $ = t.slidesSizesGrid[0], L = 0; L < o.length; L += L < s.slidesPerGroupSkip ? 1 : s.slidesPerGroup) {
                            ...
                            void 0 !== o[L + I] ? h >= o[L] && h < o[L + I] && (O = L,
                                $ = o[L + I] - o[L]) : h >= o[L] && (O = L,
                        ...
                        if (u > s.longSwipesMs) {
                            if (!s.longSwipes)
                                return void t.slideTo(t.activeIndex);
                            "next" === t.swipeDirection && (A >= s.longSwipesRatio ? t.slideTo(O + D) : t.slideTo(O)),
                            "prev" === t.swipeDirection && (A > 1 - s.longSwipesRatio ? t.slideTo(O + D) : t.slideTo(O))
                        } else {
                            if (!s.shortSwipes)
                                return void t.slideTo(t.activeIndex);
        ...
        var U = {
            ...
            update: {
                ...
                updateSlides: function() {
                    ...
                    if (void 0 !== r) {
                        ...
                        s.slidesPerColumn > 1 && (T = Math.floor(p / s.slidesPerColumn) === p / e.params.slidesPerColumn ? p : Math.ceil(p / s.slidesPerColumn) * s.slidesPerColumn,
                        "auto" !== s.slidesPerView && "row" === s.slidesPerColumnFill && (T = Math.max(T, s.slidesPerView * s.slidesPerColumn)));
                        for (var S, M, z, P = s.slidesPerColumn, O = T / P, $ = Math.floor(p / s.slidesPerColumn), L = 0; L < p; L += 1) {
                            ...
                            if (s.slidesPerColumn > 1) {
                                ...
                                if ("row" === s.slidesPerColumnFill && s.slidesPerGroup > 1) {
                                    ...
                                    A = (D = B - (N = Math.floor(B / H)) * H + G * s.slidesPerGroup) + N * T / P,
                                        I.css({
                                    ...
                                    "column" === s.slidesPerColumnFill ? (N = L - (D = Math.floor(L / P)) * P,
                                    (D > $ || D === $ && N === P - 1) && (N += 1) >= P && (N = 0,
                                        D += 1)) : D = L - (N = Math.floor(L / O)) * O;
                            ...
                            if ("none" !== I.css("display")) {
                                if ("auto" === s.slidesPerView) {
                                    ...
                                    s.roundLengths && (C = Math.floor(C)),
                                    h[L] && (h[L].style[t("width")] = C + "px");
                                h[L] && (h[L].swiperSlideSize = C),
                                    f.push(C),
                                    s.centeredSlides ? (w = w + C / 2 + E / 2 + y,
                                    0 === E && 0 !== L && (w = w - r / 2 - y),
                                    0 === L && (w = w - r / 2 - y),
                                    Math.abs(w) < .001 && (w = 0),
                                    s.roundLengths && (w = Math.floor(w)),
                                    x % s.slidesPerGroup == 0 && u.push(w),
                                        c.push(w)) : (s.roundLengths && (w = Math.floor(w)),
                        ...
                        if (e.virtualSize = Math.max(e.virtualSize, r) + m,
                            n && o && ("slide" === s.effect || "coverflow" === s.effect) && a.css({
                                width: e.virtualSize + s.spaceBetween + "px"
                            }),
                                s.setWrapperSize)
                            a.css(((M = {})[t("width")] = e.virtualSize + s.spaceBetween + "px",
                                M));
                        if (s.slidesPerColumn > 1)
                            if (e.virtualSize = (C + s.spaceBetween) * T,
                                    e.virtualSize = Math.ceil(e.virtualSize / s.slidesPerColumn) - s.spaceBetween,
                                    a.css(((z = {})[t("width")] = e.virtualSize + s.spaceBetween + "px",
                                        z)),
                                    s.centeredSlides) {
                                S = [];
                                for (var Z = 0; Z < u.length; Z += 1) {
                                    ...
                                    u[Z] < e.virtualSize + u[0] && S.push(J)
                                }
                                u = S
                            }
                        if (!s.centeredSlides) {
                    ...
                    if (0 !== i.length) {
                        ...
                        for (var r = 0; r < i.length; r += 1) {
                            ...
                            if (t.watchSlidesVisibility || t.centeredSlides && t.autoHeight) {
                                ...
                                (l >= 0 && l < this.size - 1 || d > 1 && d <= this.size || l <= 0 && d >= this.size) && (this.visibleSlides.push(n),
                ...
                updateClickedSlide: function(e) {
                    ...
                    this.clickedSlide = s,
                        this.virtual && this.params.virtual.enabled ? this.clickedIndex = parseInt(C(s).attr("data-swiper-slide-index"), 10) : this.clickedIndex = t,
            ...
            slide: {
                slideTo: function(e, t, i, s, a) {
                    ...
                    var l = n.params
                        ...
                        , f = n.wrapperEl
                        , v = n.enabled;
                    if (n.animating && l.preventInteractionOnTransition || !v && !s && !a)
                        return !1;
                    var m = Math.min(n.params.slidesPerGroupSkip, o)
                        , g = m + Math.floor((o - m) / n.params.slidesPerGroup);
                    g >= d.length && (g = d.length - 1),
                    (u || l.initialSlide || 0) === (p || 0) && i && n.emit("beforeSlideChangeStart");
                    var b, y = -d[g];
                    ...
                    if (n.initialized && o !== u) {
                        if (!n.allowSlideNext && y < n.translate && y < n.minTranslate())
                            return !1;
                        if (!n.allowSlidePrev && y > n.translate && y > n.maxTranslate() && (u || 0) !== o)
                            return !1
                    }
                    if (b = o > u ? "next" : o < u ? "prev" : "reset",
                        c && -y === n.translate || !c && y === n.translate)
                        return n.updateActiveIndex(o),
                        l.autoHeight && n.updateAutoHeight(),
                            n.updateSlidesClasses(),
                        "slide" !== l.effect && n.setTranslate(y),
                        "reset" !== b && (n.transitionStart(i, b),
                            n.transitionEnd(i, b)),
                            !1;
                    if (l.cssMode) {
                        var C, S = n.isHorizontal(), M = -y;
                        if (c && (M = f.scrollWidth - f.offsetWidth - M),
                            0 === t)
                            f[S ? "scrollLeft" : "scrollTop"] = M;
                        else if (f.scrollTo)
                            f.scrollTo(((C = {})[S ? "left" : "top"] = M,
                                C.behavior = "smooth",
                                C));
                        else
                            f[S ? "scrollLeft" : "scrollTop"] = M;
                    ...
                    return 0 === t ? (n.setTransition(0),
                        ...
                        n.transitionEnd(i, b)) : (n.setTransition(t),
                        n.setTranslate(y),
                        n.updateActiveIndex(o),
                        n.updateSlidesClasses(),
                        n.emit("beforeTransitionStart", t, s),
            ...
            loop: {
                loopCreate: function() {
                    ...
                    for (var p = 0; p < h.length; p += 1)
                        s.append(C(h[p].cloneNode(!0)).addClass(i.slideDuplicateClass));
                    for (var u = d.length - 1; u >= 0; u -= 1)
                        s.prepend(C(d[u].cloneNode(!0)).addClass(i.slideDuplicateClass))
                },
                loopFix: function() {
            ...
            events: {
                attachEvents: function() {
                    ...
                    if (!o.touch && o.pointerEvents)
                        ...
                        if (o.touch) {
                            ...
                            V || (e.addEventListener("touchstart", F),
                                V = !0)
                        }
                        (t.simulateTouch && !r.ios && !r.android || t.simulateTouch && !o.touch && r.ios) && (s.addEventListener("mousedown", this.onTouchStart, !1),
                            e.addEventListener("mousemove", this.onTouchMove, l),
                            e.addEventListener("mouseup", this.onTouchEnd, !1))
                    }
                    (t.preventClicks || t.preventClicksPropagation) && s.addEventListener("click", this.onClick, !0),
                    t.cssMode && a.addEventListener("scroll", this.onScroll),
                        t.updateOnWindowResize ? this.on(r.ios || r.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", Y, !0) : this.on("observerUpdate", Y, !0)
                },
                detachEvents: function() {
                    ...
                    if (!o.touch && o.pointerEvents)
                        ...
                        (t.simulateTouch && !r.ios && !r.android || t.simulateTouch && !o.touch && r.ios) && (s.removeEventListener("mousedown", this.onTouchStart, !1),
                            e.removeEventListener("mousemove", this.onTouchMove, l),
                            e.removeEventListener("mouseup", this.onTouchEnd, !1))
                    }
                    (t.preventClicks || t.preventClicksPropagation) && s.removeEventListener("click", this.onClick, !0),
                    t.cssMode && a.removeEventListener("scroll", this.onScroll),
                        this.off(r.ios || r.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", Y)
                }
            },
            breakpoints: {
                    ...
                    if (n && (!n || 0 !== Object.keys(n).length)) {
                        ...
                        if (o && this.currentBreakpoint !== o) {
                            ...
                            k(this, {
                                ...
                                u && !v ? this.disable() : !u && v && this.enable(),
            ...
            classes: {
                addClasses: function() {
                    var e, t, i, s = this.classNames, a = this.params, r = this.rtl, n = this.$el, o = this.device, l = this.support, d = (e = ["initialized", a.direction, {
            ...
            images: {
                loadImage: function(e, t, i, s, a, r) {
                    ...
                    C(e).parent("picture")[0] || e.complete && a ? d() : t ? ((n = new o.Image).onload = d,
                        n.onerror = d,
                    s && (n.sizes = s),
                    i && (n.srcset = i),
                    t && (n.src = t)) : d()
            ...
            , Z = function() {
            function e() {
                for (var t, i, s = arguments.length, a = new Array(s), r = 0; r < s; r++)
                    a[r] = arguments[r];
                if (1 === a.length && a[0].constructor && "Object" === Object.prototype.toString.call(a[0]).slice(8, -1) ? i = a[0] : (t = a[0],
                        i = a[1]),
                    i || (i = {}),
                        i = k({}, i),
                    t && !i.el && (i.el = t),
        ...
        var ee = {
            update: function(e) {
                ...
                m = t.rtlTranslate ? "right" : t.isHorizontal() ? "left" : "top",
                    r ? (g = Math.floor(s / 2) + a + l,
                        b = Math.floor(s / 2) + a + o) : (g = s + (a - 1) + l,
                        b = a + o);
                ...
                if (e)
                    ...
                    for (var M = h; M <= p; M += 1)
                        (M < w || M > E) && t.$wrapperEl.find("." + t.params.slideClass + '[data-swiper-slide-index="' + M + '"]').remove();
                for (var z = 0; z < u.length; z += 1)
                    z >= w && z <= E && (void 0 === p || e ? S.push(z) : (z > p && S.push(z),
                    z < h && C.push(z)));
                ...
                if (this.enabled) {
                    ...
                    if (!(a.shiftKey || a.altKey || a.ctrlKey || a.metaKey || i.activeElement && i.activeElement.nodeName && ("input" === i.activeElement.nodeName.toLowerCase() || "textarea" === i.activeElement.nodeName.toLowerCase()))) {
                        if (this.params.keyboard.onlyInViewport && (d || h || p || u || c || f)) {
                            ...
                            for (var x = [[E.left, E.top], [E.left + g, E.top], [E.left, E.top + b], [E.left + g, E.top + b]], T = 0; T < x.length; T += 1) {
                                var C = x[T];
        ...
        var re = {
            ...
            handle: function(e) {
                ...
                if (i.enabled) {
                    ...
                    var a = i.$el;
                    if ("container" !== i.params.mousewheel.eventsTarget && (a = C(i.params.mousewheel.eventsTarget)),
                    ...
                    if (l >= i.minTranslate() && (l = i.minTranslate()),
                        ...
                        if (!p) {
                            ...
                            if (u >= i.minTranslate() && (u = i.minTranslate()),
                                ...
                                (!c && i.isBeginning || !f && i.isEnd) && i.updateSlidesClasses(),
            ...
            update: function() {
                ...
                if (!this.params.loop) {
                    var i = this.navigation
                        , s = i.$nextEl
                        , a = i.$prevEl;
                    a && a.length > 0 && (this.isBeginning ? t(a, !0) : t(a, !1),
                    this.params.watchOverflow && this.enabled && a[this.isLocked ? "addClass" : "removeClass"](e.lockClass)),
                ...
                if (t.el && this.pagination.el && this.pagination.$el && 0 !== this.pagination.$el.length) {
                    ...
                    if (this.params.loop ? ((i = Math.ceil((this.activeIndex - this.loopedSlides) / this.params.slidesPerGroup)) > s - 1 - 2 * this.loopedSlides && (i -= s - 2 * this.loopedSlides),
                        ...
                        if (t.dynamicBullets && (this.pagination.bulletSize = d.eq(0)[this.isHorizontal() ? "outerWidth" : "outerHeight"](!0),
                            ...
                            d.each((function(e) {
                                    ...
                                    t.dynamicBullets && (a >= n && a <= o && s.addClass(t.bulletActiveClass + "-main"),
                                    a === n && s.prev().addClass(t.bulletActiveClass + "-prev").prev().addClass(t.bulletActiveClass + "-prev-prev"),
                                    a === o && s.next().addClass(t.bulletActiveClass + "-next").next().addClass(t.bulletActiveClass + "-next-next"))
                                }
                            ));
                        else {
                            var h = d.eq(i)
                    ...
                    if ("fraction" === t.type && (a.find($(t.currentClass)).text(t.formatFractionCurrent(i + 1)),
                        ...
                        var w = (i + 1) / r
                            , E = 1
                            , x = 1;
                        "horizontal" === y ? E = w : x = w,
                            a.find($(t.progressbarFillClass)).transform("translate3d(0,0,0) scaleX(" + E + ") scaleY(" + x + ")").transition(this.params.speed)
                    }
        ...
        var pe = {
            ...
            enableDraggable: function() {
                if (this.params.scrollbar.el) {
                    ...
                    o && (r.touch ? (o.addEventListener(i.start, this.scrollbar.onDragStart, l),
                        ...
                        o.addEventListener(i.end, this.scrollbar.onDragEnd, d)) : (o.addEventListener(s.start, this.scrollbar.onDragStart, l),
            ...
            disableDraggable: function() {
                if (this.params.scrollbar.el) {
                    ...
                    o && (r.touch ? (o.removeEventListener(i.start, this.scrollbar.onDragStart, l),
                        ...
                        o.removeEventListener(i.end, this.scrollbar.onDragEnd, d)) : (o.removeEventListener(s.start, this.scrollbar.onDragStart, l),
            ...
            init: function() {
                if (this.params.scrollbar.el) {
                    ...
                    0 === a.length && (a = C('<div class="' + this.params.scrollbar.dragClass + '"></div>'),
                        s.append(a)),
                        k(e, {
                            $el: s,
                            el: s[0],
                    ...
                    s && s[this.enabled ? "removeClass" : "addClass"](this.params.scrollbar.lockClass)
                }
            },
            destroy: function() {
        ...
        var ve = {
            ...
            onGestureStart: function(e) {
                ...
                if (s.fakeGestureTouched = !1,
                    ...
                    s.fakeGestureTouched = !0,
                        a.scaleStart = ve.getDistanceBetweenTouches(e)
                }
                a.$slideEl && a.$slideEl.length || (a.$slideEl = C(e.target).closest("." + this.params.slideClass),
            ...
            onGestureChange: function(e) {
                ...
                if (!t.gestures) {
                    ...
                    s.fakeGestureMoved = !0,
                        a.scaleMove = ve.getDistanceBetweenTouches(e)
                }
            ...
            onTouchMove: function(e) {
                ...
                if (i.$imageEl && 0 !== i.$imageEl.length && (this.allowClick = !1,
                    ...
                    s.isMoved || (s.width = i.$imageEl[0].offsetWidth,
                        ...
                        s.startX = z(i.$imageWrapEl[0], "x") || 0,
                        s.startY = z(i.$imageWrapEl[0], "y") || 0,
            ...
            in: function(e) {
                var t, i, s, a, r, n, o, d, h, p, u, c, f, v, m, g, b = l(), y = this.zoom, w = this.params.zoom, E = y.gesture, x = y.image;
                (E.$slideEl || (this.params.virtual && this.params.virtual.enabled && this.virtual ? E.$slideEl = this.$wrapperEl.children("." + this.params.slideActiveClass) : E.$slideEl = this.slides.eq(this.activeIndex),
                    E.$imageEl = E.$slideEl.find("img, svg, canvas, picture, .swiper-zoom-target"),
                    E.$imageWrapEl = E.$imageEl.parent("." + w.containerClass)),
                E.$imageEl && 0 !== E.$imageEl.length && E.$imageWrapEl && 0 !== E.$imageWrapEl.length) && (E.$slideEl.addClass("" + w.zoomedSlideClass),
                    ...
                    y.currentScale = E.$imageWrapEl.attr("data-swiper-zoom") || w.maxRatio,
                    e ? (m = E.$slideEl[0].offsetWidth,
                        g = E.$slideEl[0].offsetHeight,
                        s = E.$slideEl.offset().left + b.scrollX + m / 2 - t,
                        a = E.$slideEl.offset().top + b.scrollY + g / 2 - i,
                    ...
                    n > v && (n = v)) : (r = 0,
                        n = 0),
                    E.$imageWrapEl.transition(300).transform("translate3d(" + r + "px, " + n + "px,0)"),
                    E.$imageEl.transition(300).transform("translate3d(0,0,0) scale(" + y.scale + ")"))
            },
            out: function() {
                var e = this.zoom
                    , t = this.params.zoom
                ...
                i.$imageEl && 0 !== i.$imageEl.length && i.$imageWrapEl && 0 !== i.$imageWrapEl.length && (e.scale = 1,
                    e.currentScale = 1,
            ...
            load: function() {
                ...
                if (n.loadPrevNext)
                    if (o > 1 || n.loadPrevNextAmount && n.loadPrevNextAmount > 1) {
                        for (var p = n.loadPrevNextAmount, u = o, c = Math.min(a + u + Math.max(p, u), s.length), f = Math.max(a - Math.max(u, p), 0), v = a + o; v < c; v += 1)
        ...
        var Ee = {
            ...
            init: function() {
                ...
                var s, a, r = e.$wrapperEl, n = r.attr("id") || "swiper-wrapper-" + e.a11y.getRandomNumber(16), o = e.params.autoplay && e.params.autoplay.enabled ? "off" : "polite";
                e.a11y.addElId(r, n),
                ...
                "BUTTON" !== a[0].tagName && (e.a11y.addElRole(a, "button"),
                    ...
                    e.a11y.addElControls(a, n)),
                e.pagination && e.params.pagination.clickable && e.pagination.bullets && e.pagination.bullets.length && e.pagination.$el.on("keydown", $(e.params.pagination.bulletClass), e.a11y.onEnterOrSpaceKey)
            },
            destroy: function() {
                var e, t;
                ...
                this.pagination && this.params.pagination.clickable && this.pagination.bullets && this.pagination.bullets.length && this.pagination.$el.off("keydown", $(this.params.pagination.bulletClass), this.a11y.onEnterOrSpaceKey)
            }
        };
        function xe() {
        ...
        var Te = {
            init: function() {
                ...
                if (this.params.history) {
                    ...
                    var t = this.history;
                    t.initialized = !0,
                        t.paths = Te.getPathValues(this.params.url),
            ...
            setHistoryPopState: function() {
                this.history.paths = Te.getPathValues(this.params.url),
        ...
        var $e = {
            setTranslate: function() {
                var e, t = this.$el, i = this.$wrapperEl, s = this.slides, a = this.width, r = this.height, n = this.rtlTranslate, o = this.size, l = this.browser, d = this.params.cubeEffect, h = this.isHorizontal(), p = this.virtual && this.params.virtual.enabled, u = 0;
                d.shadow && (h ? (0 === (e = i.find(".swiper-cube-shadow")).length && (e = C('<div class="swiper-cube-shadow"></div>'),
                    i.append(e)),
                    e.css({
                        height: a + "px"
                ...
                for (var c = 0; c < s.length; c += 1) {
                    ...
                    if (b <= 1 && b > -1 && (u = 90 * v + 90 * b,
                        n && (u = 90 * -v - 90 * b)),
                            f.transform(x),
                            d.slideShadows) {
                        var T = h ? f.find(".swiper-slide-shadow-left") : f.find(".swiper-slide-shadow-top")
                            , S = h ? f.find(".swiper-slide-shadow-right") : f.find(".swiper-slide-shadow-bottom");
                        0 === T.length && (T = C('<div class="swiper-slide-shadow-' + (h ? "left" : "top") + '"></div>'),
                            f.append(T)),
                        0 === S.length && (S = C('<div class="swiper-slide-shadow-' + (h ? "right" : "bottom") + '"></div>'),
                            f.append(S)),
            ...
            setTranslate: function() {
                for (var e = this.slides, t = this.rtlTranslate, i = 0; i < e.length; i += 1) {
                    ...
                    if (this.isHorizontal() ? t && (r = -r) : (l = o,
                        ...
                        0 === d.length && (d = C('<div class="swiper-slide-shadow-' + (this.isHorizontal() ? "left" : "top") + '"></div>'),
                            s.append(d)),
                        0 === h.length && (h = C('<div class="swiper-slide-shadow-' + (this.isHorizontal() ? "right" : "bottom") + '"></div>'),
                            s.append(h)),
            ...
            setTranslate: function() {
                for (var e = this.width, t = this.height, i = this.slides, s = this.slidesSizesGrid, a = this.params.coverflowEffect, r = this.isHorizontal(), n = this.translate, o = r ? e / 2 - n : t / 2 - n, l = r ? a.rotate : -a.rotate, d = a.depth, h = 0, p = i.length; h < p; h += 1) {
                    ...
                    if (u.transform(x),
                        ...
                        0 === T.length && (T = C('<div class="swiper-slide-shadow-' + (r ? "left" : "top") + '"></div>'),
                            u.append(T)),
            ...
            onThumbClick: function() {
                ...
                if (e) {
                    ...
                    if (!(i && C(i).hasClass(this.params.thumbs.slideThumbActiveClass) || null == t)) {
                        var s;
                        if (s = e.params.loop ? parseInt(C(e.clickedSlide).attr("data-swiper-slide-index"), 10) : t,
                                this.params.loop) {
                            var a = this.activeIndex;
                ...
                click: function(e, t) {
                    ...
                    if (e.params.navigation.hideOnClick && !C(r).is(a) && !C(r).is(s)) {
                        if (e.pagination && e.params.pagination && e.params.pagination.clickable && (e.pagination.el === r || e.pagination.el.contains(r)))
                            return;
                        var n;
                        s ? n = s.hasClass(e.params.navigation.hiddenClass) : a && (n = a.hasClass(e.params.navigation.hiddenClass)),
