    ...
    (function (t) {
        ...
        196: function (t, e, n) {
            ...
            var l = ["transitionend", "webkitTransitionEnd", "oTransitionEnd"],
                c = ["transition", "MozTransition", "webkitTransition", "WebkitTransition", "OTransition"],
                d =
            ...
            var h = {
                        ...
                        if (i) {
                            ...
                            if (!0 === t) {
                                var l = function t() {
                                    var n = +new Date() - u,
                                        i = o(n, s, a, e);
                                    (r.scrollTop = i), n < e ? requestAnimationFrame(t) : (r.scrollTop = a);
                                };
                                l();
                            } else r.scrollTop = a;
                        }
                ...
                _swipeOut: function (t, e) {
                    ...
                    setTimeout(function () {
                        ...
                        if (i) {
                            var o = new n(i);
                            o.get("pan").set({ direction: n.DIRECTION_ALL, threshold: 250 }), o.on("panleft", e);
                        }
                    }, 500);
                },
                ...
                _setCollapsed: function (t) {
                    ...
                    this.isSmallScreen()
                        ...
                        : this[t ? "_addClass" : "_removeClass"]("layout-menu-collapsed");
                },
                ...
                scrollPageTo: function (t) {
                    ...
                    "string" == typeof t && (t = document.querySelector(t)), "number" != typeof t && (t = t.getBoundingClientRect().top + i.scrollTop);
                    var o = i.scrollTop,
                        r = t - o,
                        s = +new Date(),
                        a = function a() {
                            var u = +new Date() - s,
                                l = n(u, o, r, e);
                            (i.scrollTop = l), u < e ? requestAnimationFrame(a) : (i.scrollTop = t);
                        };
                    a();
                },
                        ...
                        n && this._supportsTransitionEnd()
                            ...
                            e && this._setMenuHoverState(!1),
                                this._bindLayoutAnimationEndEvent(
                                    ...
                                    function () {
                                        t._removeClass("layout-transitioning"), t._triggerWindowEvent("resize"), t._triggerEvent("toggle"), t._setMenuHoverState(!1);
                                    }
                                ))
                            ...
                            e && this._setMenuHoverState(!1),
                                ...
                                setTimeout(function () {
                                    t._removeClass("layout-no-transition"), t._triggerWindowEvent("resize"), t._triggerEvent("toggle"), t._setMenuHoverState(!1);
                                }, 1)));
                },
                ...
                setAutoUpdate: function () {
                    ...
                    e && !this._autoUpdate
                        ? (this.on("resize.Helpers:autoUpdate", function () {
                            ...
                            (this._autoUpdate = !0))
                        : !e && this._autoUpdate && (this.off("resize.Helpers:autoUpdate"), (this._autoUpdate = !1));
                },
                ...
                on: function () {
                    var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : f("event"),
                        ...
                        u = i(a),
                        l = u.slice(1);
                    (l = l.join(".") || null), this._listeners.push({ event: s, namespace: l, callback: e });
                },
                off: function () {
                    var t = this,
                    ...
                    document.querySelectorAll('[data-bs-toggle="sidebar"]').forEach(function (t) {
                        t.addEventListener("click", function () {
                            ...
                            document.querySelectorAll(e).forEach(function (t) {
                                ...
                                !1 !== n &&
                                void 0 !== i &&
                                (t.classList.contains("show") ? i[0].classList.add("show") : i[0].classList.remove("show"),
                                    i[0].addEventListener("click", function (e) {
                                        e.currentTarget.classList.remove("show"), t.classList.remove("show");
                                    }));
                            });
                        });
                    });
            ...
            h.isMobileDevice() && window.chrome && document.documentElement.classList.add("layout-menu-100vh"),
                "complete" === document.readyState
                    ...
                    : document.addEventListener("DOMContentLoaded", function t() {
                        h.update(), document.removeEventListener("DOMContentLoaded", t);
                    }));
        },
    })
);
