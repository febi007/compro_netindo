    ...
    $(function() {
        ...
        $("#closeButton").click(function() {
            ...
            $("#showtoast").click(function() {
                var p = $("#toastTypeGroup input:radio:checked").val()
                    , t = "rtl" === $("html").attr("dir")
                    , e = $("#message").val()
                    , u = $("#title").val() || ""
                    , o = $("#showDuration")
                ...
                r != toastr.options.positionClass && (toastr.options.hideDuration = 0,
                    toastr.clear()),
                ...
                o.val().length && (toastr.options.showDuration = parseInt(o.val())),
                s.val().length && (toastr.options.hideDuration = parseInt(s.val())),
                a.val().length && (toastr.options.timeOut = l ? 0 : parseInt(a.val())),
                n.val().length && (toastr.options.extendedTimeOut = l ? 0 : parseInt(n.val())),
                i.val().length && (toastr.options.showEasing = i.val()),
                d.val().length && (toastr.options.hideEasing = d.val()),
                h.val().length && (toastr.options.showMethod = h.val()),
                m.val().length && (toastr.options.hideMethod = m.val()),
                l && (t = (t = e) || "Clear itself?",
                    e = t += '<br /><br /><button type="button" class="btn btn-secondary clear">Yes</button>',
                ...
                void 0 !== (k = c) && (c.find("#okBtn").length && c.delegate("#okBtn", "click", function() {
                    alert("you clicked me. i was toast #" + v + ". goodbye!"),
                        c.remove()
                }),
