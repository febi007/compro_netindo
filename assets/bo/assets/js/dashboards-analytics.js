...
!(function () {
    ...
    (i = document.querySelector("#totalRevenueChart")),
        (a = {
            ...
            plotOptions: { bar: { horizontal: !1, columnWidth: "33%", borderRadius: 12, startingShape: "rounded", endingShape: "rounded" } },
            ...
            grid: { borderColor: s, padding: { top: 0, bottom: -8, left: 20, right: 20 } },
            xaxis: { categories: ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul"], labels: { style: { fontSize: "13px", colors: e } }, axisTicks: { show: !1 }, axisBorder: { show: !1 } },
            yaxis: { labels: { style: { fontSize: "13px", colors: e } } },
            responsive: [
        ...
        (a = {
            ...
            plotOptions: {
                radialBar: {
                    ...
                    dataLabels: { name: { offsetY: 15, color: r, fontSize: "15px", fontWeight: "600", fontFamily: "Public Sans" }, value: { offsetY: -25, color: r, fontSize: "22px", fontWeight: "500", fontFamily: "Public Sans" } },
                },
            },
    ...
    (i = document.querySelector("#revenueChart")),
        (a = {
            chart: { height: 80, type: "bar", toolbar: { show: !1 } },
            plotOptions: { bar: { barHeight: "80%", columnWidth: "75%", startingShape: "rounded", endingShape: "rounded", borderRadius: 2, distributed: !0 } },
            ...
            legend: { show: !1 },
            xaxis: { categories: ["M", "T", "W", "T", "F", "S", "S"], axisBorder: { show: !1 }, axisTicks: { show: !1 }, labels: { style: { colors: config.colors.secondary, fontSize: "13px" } } },
            yaxis: { labels: { show: !1 } },
        });
    if (null !== i) {
    ...
    (i = document.querySelector("#profileReportChart")),
        (a = {
            chart: { height: 80, type: "line", toolbar: { show: !1 }, dropShadow: { enabled: !0, top: 10, left: 5, blur: 3, color: config.colors.warning, opacity: 0.15 }, sparkline: { enabled: !0 } },
            grid: { show: !1, padding: { right: 8 } },
    ...
    (i = document.querySelector("#incomeChart")),
        (a = {
            ...
            xaxis: { categories: ["", "Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul"], axisBorder: { show: !1 }, axisTicks: { show: !1 }, labels: { show: !0, style: { fontSize: "13px", colors: e } } },
