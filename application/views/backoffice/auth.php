...
<!DOCTYPE html>
<html lang="en" class="light-style  customizer-hide" dir="ltr" data-theme="theme-default" data-assets-path="<?=base_url().'assets/bo'?>/assets/" data-template="vertical-menu-template">

<head>
    <meta charset="utf-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0, user-scalable=no, minimum-scale=1.0, maximum-scale=1.0" />

    <title>NETINDO - MASUK BACKOFFICE</title>
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/x-icon" href="<?=base_url().'assets/bo'?>/assets/img/favicon/favicon.ico" />
    ...
    <!-- Vendor -->
    <link rel="stylesheet" href="<?=base_url().'assets/bo'?>/assets/vendor/libs/formvalidation/dist/css/formValidation.min.css" />
    <!-- Page -->
    <link rel="stylesheet" href="<?=base_url().'assets/bo'?>/assets/vendor/css/pages/page-auth.css">
    ...
    <style>
        ...
        #toast-container> .bx-check-circle, .toast  {
            background-color: #696cff !important;
        }
        #toast-container> .bx-message-error, .toast  {
            background-color: #ff3e1d !important;
        }
        #toast-container> .bx bx-info-circle, .toast  {
            background-color: #ff3e1d !important;
        }
        .toast-message{
    ...
    <div class="authentication-inner row m-0">
        <div class="d-none d-lg-flex col-lg-7 col-xl-8 align-items-center p-5">
            <div class="w-100 d-flex justify-content-center">
                <img src="https://demos.themeselection.com/materio-vuetify-vuejs-laravel-admin-template/demo-3/images/group-light.png?ffe341d86dfd5b979186b025d11ac0bd" class="img-fluid" alt="Login image" width="500" data-app-dark-img="illustrations/boy-with-rocket-dark.png" data-app-light-img="illustrations/boy-with-rocket-light.png">
            </div>
        </div>
        <div class="d-flex col-12 col-lg-5 col-xl-4 align-items-center authentication-bg p-sm-5 p-4">
            <div class="w-px-400 mx-auto">

                <h4 class="mb-2">Masuk Backoffice Netindo 👋</h4>
                <form id="form_input">
                    <div class="mb-3">
        ...
        submitHandler: function (form) {
            ...
            $.ajax({
                ...
                beforeSend: function() {
                    ...
                    $("#btnSubmit").text('');
                    $("#btnSubmit").append('<span class="spinner-border" role="status" aria-hidden="true"></span>')
