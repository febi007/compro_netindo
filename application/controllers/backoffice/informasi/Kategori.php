...
class Kategori extends MY_Controller
{
    public function __construct()
    {
        ...
        $this->indexFile= $this->pathFile.$this->kategori.'/'.$this->index;
        $this->dataFile = $this->pathFile.$this->kategori.'/data';
        $this->tbl      = $this->kategoriInformasi;
        $this->baseView = $this->informasi.'/'.$this->kategori;
    }
